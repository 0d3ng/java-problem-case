...
public class SelectionSortTest {
    ...
    public void testSelectionSort1() {
        ...
        try {
            assertEquals("Test 1:", Arrays.toString(expectedOutput),
    ...
    public void testSelectionSort2() {
        ...
        try {
            assertEquals("Test 2:", Arrays.toString(expectedOutput),
                    Arrays.toString(codeOutput));
        } catch (AssertionError ae) {
            System.out.println(ae);
        }
    ...
    public void testSelectionSort3() {
        ...
        try {
            assertEquals("Test 3:", Arrays.toString(expectedOutput),
                    Arrays.toString(codeOutput));
        } catch (AssertionError ae) {
            System.out.println(ae);
        }
